...
\
    ...
    def build(self, func_data: Dict[str, Any]) -> Optional[LabelAnnotationBuildResult]:
        ...
        vulnerable_code_details = self._build_vulnerable_code_details(
            func_code=str(func_data.get("function_code") or ""),
            func_start_line=int(func_data.get("start_line") or 1),
        ...
        annotation: Dict[str, Any] = {
            ...
            "vulnerable_code_details": vulnerable_code_details,
            "slither_section": slither_section,
        }

        return LabelAnnotationBuildResult(
    ...
    def _build_vulnerable_code_details(
        self,
        func_code: str,
        func_start_line: int,
        vuln_details: List[Dict[str, Any]],
